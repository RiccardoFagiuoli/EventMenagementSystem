...
path('event/<int:pk>/unregister/confirm/', views.event_unregister_confirm, name='event_unregister_confirm'),
    ...
    path('event/<int:event_id>/admin-unregister/<int:registration_id>/confirm/', views.admin_unregister_confirm, name='admin_unregister_confirm'),
    path('event/<int:pk>/register-user/<int:registration_pk>/', views.admin_register_user, name='admin_register_user'),
    path('event/<int:pk>/admin-register/<int:registration_pk>/confirm/', views.admin_register_confirm, name='admin_register_confirm'),
